...
// GET - Fetch all leave applications (with optional filtering)
...
// DELETE - Delete leave application (for HR/Admin)
router.delete("/:id", async (req, res) => {
  try {
    const deletedLeave = await LeaveApplication.findByIdAndDelete(req.params.id);
